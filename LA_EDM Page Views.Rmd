...
```{r}
ggplot(data = df, aes(date,views, color=Technique)) + geom_line(size=1) + scale_y_continuous(labels = comma) + geom_area(aes(fill=Technique)) + labs(list(title = "Number of EDM and LA Page Views on Wikipedia in 2016", x = "Date", y = "Number of Views")) 
```